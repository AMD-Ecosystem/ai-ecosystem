...
************************************************************
Primus Megatron training performance testing version history
************************************************************

This table lists previous releases of the Primus AI training Docker image. The
following documentation archives use Primus with the Megatron-LM backend and
...
.. list-table::
   ...
   * - v26.3
     ...
     -
       * `Primus Megatron documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/primus-megatron-v26.3.html>`__
   ...
   * - v26.2
     -
       ...
       * PyTorch 2.10.0+git94c6e04
     -
       * `Primus Megatron documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/primus-megatron-v26.2.html>`__
   ...
   * - v26.1
     ...
     -
       * `Primus Megatron documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/primus-megatron-v26.1.html>`__
   ...
   * - v25.11
     -
       ...
       * PyTorch 2.10.0.dev20251112+rocm7.1
     -
       * `Primus Megatron documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/primus-megatron-v25.11.html>`__
       * `Megatron-LM (legacy) <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/megatron-lm-v25.11.html>`__
   ...
   * - v25.10
     -
       ...
       * PyTorch 2.10.0.dev20251112+rocm7.1
     -
       * `Primus Megatron documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/primus-megatron-v25.10.html>`__
       * `Megatron-LM (legacy) <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/megatron-lm-v25.10.html>`__
   ...
   * - v25.9
     ...
     -
       * `Primus Megatron documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/primus-megatron-v25.9.html>`__
       * `Megatron-LM (legacy) <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/megatron-lm-v25.9.html>`__
   ...
   * - v25.8
     ...
     -
       * `Primus Megatron documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/primus-megatron-v25.8.html>`__
       * `Megatron-LM (legacy) <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/megatron-lm-v25.8.html>`__
   ...
   * - v25.7
     -
       ...
       * PyTorch 2.8.0a0+gitd06a406
     -
       * `Primus Megatron documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/primus-megatron-v25.7.html>`__
       * `Megatron-LM (legacy) <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/megatron-lm-v25.7.html>`__
   ...
   * - v25.6
     ...
     -
       * `Documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/megatron-lm-v25.6.html>`__
   ...
   * - v25.5
     ...
     -
       * `Documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/megatron-lm-v25.5.html>`__
   ...
   * - v25.4
     ...
     -
       * `Documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/megatron-lm-v25.4.html>`__
   ...
   * - v25.3
     -
       ...
       * PyTorch 2.7.0a0+git637433
     -
       * `Documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/megatron-lm-v25.3.html>`__
   ...
   * - v24.12-dev
     -
       ...
       * PyTorch 2.4.0
     -
       * `Documentation <https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/megatron-lm-v24.12-dev.html>`__
